const state = () => ({
    ...
    deliveryTypes: [
        {   
            id: 1123,
            label: 'Самовывоз', 
            description: 'адреса ПВЗ ул. Одинцова 48',
            cost: null, 
            costProcent: false, 
            freeCostfrom: null,
            active: true,
        ...
        {   
            id: 3,
            label: 'Курьер',
            description: '14 рублей курьером в любой город',
            cost: 14, 
            costProcent: false,
            freeCostfrom: null,
            active: true,
        ...
        {   
            id: 4,
            label: 'По Минску',
            description: 'Бесплатная от 50 руб',
            cost: 9, 
            costProcent: false,
            freeCostfrom: 50,
            active: true,
...
const actions = {
    ...
    async SAVE_NEW_ORDER(context, payload) {
        await this.$axios.$post('/api/order', { order: payload })
    }
}
